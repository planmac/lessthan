...
There is no explicit method to flush system i/o buffers other than closing the file. There is no method to move the file pointer other than reading from the file. [MAY WANT TO RETHINK THINK THIS]
